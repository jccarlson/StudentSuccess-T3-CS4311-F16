                        ...
                        <div id="MainContentWrapperInner">
                            ...
                            <div id="DetailedResourcesContainer">
                                ...
                                <div id="detailedviewButtonWrapper">
                                    ...
                                    <button onclick="document.location='projectDetailedView.php'">Cancel</button>
                                ...
                                <div id="InitiativesAssociatedWithProjectBox" class="box">
                                    ...
                                    <table id="InitiativesTable" class="detailedViewTable">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="activityDetailedView.php">Activity Title 1</a> </td>
                                                <td>Description 1</td>
                                                <td>MM-DD-YYY</td>
                                                <td>No</td>
                                                <td><a href="activityDetailedView.php">Owner A</a></td>
                                            </tr>

                                            <tr>
                                                <td><a href="activityDetailedView.php">Activity Title 2</a> </td>
                                                <td>Description 2</td>
                                                <td>MM-DD-YYY</td>
                                                <td>Yes</td>
                                            ...
                                            <tr>
                                                <td><a href="activityDetailedView.php">Activity Title 3</a> </td>
                                                <td>Description 3</td>
                                                <td>MM-DD-YYY</td>
                                                <td>No</td>
                                                <td><a href="/somelink">Owner A</a></td>
                                    ...
                                    <button id="LinkInitiativeButton"onclick="document.location = 'linkExistingActivity.php'">Link Existing Activity</button>
