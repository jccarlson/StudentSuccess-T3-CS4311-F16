                        ...
                        <div id="MainContentWrapperInner">
                            <div id="ResourcesContainer">
                                <div id="fundedListContainer" class="box">
                                    ...
                                    <p class="header14PBold" style="margin-left: 10px">List of Existing Initiative</p>
                                    <p class="header12P" style="margin-left: 10px">Please select an initiative(s) to link to the proj.</p>
                                    <input id="searchInitiative" style="margin-left: 960px;"  type="text" placeholder="Search Initiative">
                                    ...
                                    <div id="fundedProjectsbuttonWrapper">
                                        ...
                                        <button onclick="alert('Linking Cancelled'); document.location = 'projectDetailedView.php'">Cancel</button
                                    </div>
